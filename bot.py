...
def generate_hotel_response(user_query):
    system_prompt = f"""
    You are the official AI assistant for Coconut Groove (managed by Arbaz Khan).
    Use the following hotel information to answer questions.
    If the answer isn't in the info, politely say "Please contact our manager Arbaz Khan directly for that!"
...
if "messages" not in st.session_state:
    st.session_state.messages = [
        {"role": "assistant", "content": "Welcome to Coconut Groove! How can I help you today?"}
    ]
